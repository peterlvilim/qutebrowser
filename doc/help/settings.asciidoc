...
|<<ui-confirm-quit-tabs,confirm-quit-tabs>>|Whether to confirm quitting the application when tabs are open.
|<<ui-confirm-quit-downloads,confirm-quit-downloads>>|Whether to confirm quitting the application when downloads are running .
...
[[ui-confirm-quit-downloads]]
=== confirm-quit-downloads
Whether to confirm quitting the application when downloads are running .
